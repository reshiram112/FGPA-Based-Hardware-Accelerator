...
#
# Script generated by Vivado on Sat May 09 00:01:18 +0530 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bnn_accelerator.sh
...
#
# Usage        : bnn_accelerator.sh
#                bnn_accelerator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bnn_accelerator.sh [-reset_run]
#                bnn_accelerator.sh [-reset_log]
#                bnn_accelerator.sh [-help]
#
...
# script info
echo -e "bnn_accelerator.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bnn_accelerator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L xpm -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot bnn_accelerator xil_defaultlib.bnn_accelerator xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bnn_accelerator -key {Behavioral:sim_1:Functional:bnn_accelerator} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_aed6.protoinst" -protoinst "protoinst_files/bnn_accelerator_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bnn_accelerator.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bnn_accelerator.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bnn_accelerator.sh [-help]\n\
Usage: bnn_accelerator.sh [-step]\n\
Usage: bnn_accelerator.sh [-lib_map_path]\n\
Usage: bnn_accelerator.sh [-reset_run]\n\
Usage: bnn_accelerator.sh [-reset_log]\n\
Usage: bnn_accelerator.sh [-keep_index]\n\
Usage: bnn_accelerator.sh [-noclean_files]\n\n\
