...
# Testbench (needs mlp_weights.h in same dir after running export script)
add_files -tb mlp_tb.cpp -cflags "-I." -csimflags "-I."
...
if {[file exists "mlp_weights.h"]} {
    puts "Running C simulation..."
    csim_design -clean
} else {
    puts "mlp_weights.h not found — skipping C-sim."
    puts "Run 01_export_weights_colab.py first, then copy mlp_weights.h here."
}
