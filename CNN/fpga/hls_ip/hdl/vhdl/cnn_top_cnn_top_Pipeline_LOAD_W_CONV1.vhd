...
entity cnn_top_cnn_top_Pipeline_LOAD_W_CONV1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cnn_top_cnn_top_Pipeline_LOAD_W_CONV1 is 
...
attribute shreg_extract : string;
    ...
    signal i_3_reg_129 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal i_3_reg_129_pp0_iter1_reg : STD_LOGIC_VECTOR (6 downto 0);
    signal weights_addr_read_reg_138 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln74_fu_113_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_grp0 : BOOLEAN;
    signal i_fu_50 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
    signal add_ln74_fu_96_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_3 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal w_conv1_we0_local : STD_LOGIC;
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                i_3_reg_129_pp0_iter1_reg <= i_3_reg_129;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln74_fu_96_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_3) + unsigned(ap_const_lv7_1));
    ...
    ap_sig_allocacmp_i_3_assign_proc : process(ap_CS_fsm_pp0_stage0, i_fu_50, ap_loop_init, ap_block_pp0_stage0)
    begin
    ...
    icmp_ln74_fu_90_p2 <= "1" when (ap_sig_allocacmp_i_3 = ap_const_lv7_48) else "0";
    ...
    w_conv1_address0 <= zext_ln74_fu_113_p1(7 - 1 downto 0);
    w_conv1_ce0 <= w_conv1_ce0_local;

    w_conv1_ce0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
    ...
    w_conv1_d0 <= weights_addr_read_reg_138;
    w_conv1_we0 <= w_conv1_we0_local;

    w_conv1_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            w_conv1_we0_local <= ap_const_logic_1;
        else 
            w_conv1_we0_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    zext_ln74_fu_113_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_3_reg_129_pp0_iter1_reg),64));
end behav;
