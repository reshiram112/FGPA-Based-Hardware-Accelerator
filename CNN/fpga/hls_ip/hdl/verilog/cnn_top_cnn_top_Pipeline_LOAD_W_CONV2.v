...
module cnn_top_cnn_top_Pipeline_LOAD_W_CONV2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [10:0] i_reg_129_pp0_iter1_reg;
reg   [15:0] weights_addr_read_reg_138;
wire   [63:0] zext_ln82_fu_113_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [10:0] i_2_fu_50;
wire   [10:0] add_ln82_fu_96_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_i;
wire    ap_block_pp0_stage0;
reg    w_conv2_we0_local;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln82_fu_90_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln82_fu_90_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        w_conv2_we0_local = 1'b1;
    end else begin
        w_conv2_we0_local = 1'b0;
    end
end
...
assign add_ln82_fu_96_p2 = (ap_sig_allocacmp_i + 11'd1);
...
assign icmp_ln82_fu_90_p2 = ((ap_sig_allocacmp_i == 11'd1152) ? 1'b1 : 1'b0);
...
assign w_conv2_address0 = zext_ln82_fu_113_p1;

assign w_conv2_ce0 = w_conv2_ce0_local;

assign w_conv2_d0 = weights_addr_read_reg_138;

assign w_conv2_we0 = w_conv2_we0_local;

assign zext_ln82_fu_113_p1 = i_reg_129_pp0_iter1_reg;

endmodule //cnn_top_cnn_top_Pipeline_LOAD_W_CONV2
