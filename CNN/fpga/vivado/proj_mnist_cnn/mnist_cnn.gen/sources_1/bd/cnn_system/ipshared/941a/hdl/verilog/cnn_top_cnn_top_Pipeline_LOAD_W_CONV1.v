...
module cnn_top_cnn_top_Pipeline_LOAD_W_CONV1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [62:0] sext_ln74;
output  [6:0] w_conv1_address0;
output   w_conv1_ce0;
output   w_conv1_we0;
output  [15:0] w_conv1_d0;
...
reg   [6:0] i_3_reg_129_pp0_iter1_reg;
reg   [15:0] weights_addr_read_reg_138;
wire   [63:0] zext_ln74_fu_113_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [6:0] i_fu_50;
wire   [6:0] add_ln74_fu_96_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_i_3;
wire    ap_block_pp0_stage0;
reg    w_conv1_we0_local;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        w_conv1_we0_local = 1'b1;
    end else begin
        w_conv1_we0_local = 1'b0;
    end
end
...
assign add_ln74_fu_96_p2 = (ap_sig_allocacmp_i_3 + 7'd1);
...
assign icmp_ln74_fu_90_p2 = ((ap_sig_allocacmp_i_3 == 7'd72) ? 1'b1 : 1'b0);
...
assign w_conv1_address0 = zext_ln74_fu_113_p1;

assign w_conv1_ce0 = w_conv1_ce0_local;

assign w_conv1_d0 = weights_addr_read_reg_138;

assign w_conv1_we0 = w_conv1_we0_local;

assign zext_ln74_fu_113_p1 = i_3_reg_129_pp0_iter1_reg;

endmodule //cnn_top_cnn_top_Pipeline_LOAD_W_CONV1
