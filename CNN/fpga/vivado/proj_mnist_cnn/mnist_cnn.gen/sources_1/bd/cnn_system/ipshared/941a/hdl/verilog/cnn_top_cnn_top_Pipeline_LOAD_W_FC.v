...
module cnn_top_cnn_top_Pipeline_LOAD_W_FC (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [12:0] i_2_reg_129;
reg    ap_block_pp0_stage0_11001;
reg   [12:0] i_2_reg_129_pp0_iter1_reg;
reg   [15:0] weights_addr_read_reg_138;
wire   [63:0] zext_ln90_fu_113_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [12:0] i_fu_50;
wire   [12:0] add_ln90_fu_96_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln90_fu_90_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln90_fu_90_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln90_fu_96_p2 = (ap_sig_allocacmp_i_2 + 13'd1);
...
assign icmp_ln90_fu_90_p2 = ((ap_sig_allocacmp_i_2 == 13'd7840) ? 1'b1 : 1'b0);
...
assign w_fc_address0 = zext_ln90_fu_113_p1;

assign w_fc_ce0 = w_fc_ce0_local;

assign w_fc_d0 = weights_addr_read_reg_138;

assign w_fc_we0 = w_fc_we0_local;

assign zext_ln90_fu_113_p1 = i_2_reg_129_pp0_iter1_reg;

endmodule //cnn_top_cnn_top_Pipeline_LOAD_W_FC
