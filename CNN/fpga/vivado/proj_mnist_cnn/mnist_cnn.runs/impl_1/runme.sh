...
HD_PWD='C:/Users/Akshay/OneDrive/Desktop/FGPA-Based-Hardware-Accelerator/CNN/fpga/vivado/proj_mnist_cnn/mnist_cnn.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnn_system_wrapper.tcl -notrace
