...
HD_PWD='C:/Users/Akshay/OneDrive/Desktop/FGPA-Based-Hardware-Accelerator/CNN/fpga/vivado/proj_mnist_cnn/mnist_cnn.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnn_system_wrapper.tcl
