...
HD_PWD='C:/Users/Akshay/OneDrive/Desktop/FGPA-Based-Hardware-Accelerator/CNN/fpga/vivado/proj_mnist_cnn/mnist_cnn.runs/cnn_system_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_system_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnn_system_axi_dma_0_0.tcl
