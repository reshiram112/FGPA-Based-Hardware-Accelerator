...
ISEStep( "vivado",
         "-log cnn_system_axi_ic_ctrl_imp_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnn_system_axi_ic_ctrl_imp_auto_pc_0.tcl" );
