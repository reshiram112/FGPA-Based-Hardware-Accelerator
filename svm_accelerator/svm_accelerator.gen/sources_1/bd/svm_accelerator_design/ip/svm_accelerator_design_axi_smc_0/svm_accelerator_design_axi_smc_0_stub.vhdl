...
-- Date        : Fri May  8 20:56:28 2026
-- Host        : LAPTOP-VNMTQE0B running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top svm_accelerator_design_axi_smc_0 -prefix
--               svm_accelerator_design_axi_smc_0_ svm_accelerator_design_axi_smc_0_stub.vhdl
-- Design      : svm_accelerator_design_axi_smc_0
...
entity svm_accelerator_design_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of svm_accelerator_design_axi_smc_0 : entity is "svm_accelerator_design_axi_smc_0,bd_3f5c,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of svm_accelerator_design_axi_smc_0 : entity is "svm_accelerator_design_axi_smc_0,bd_3f5c,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=25,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of svm_accelerator_design_axi_smc_0 : entity is "yes";
end svm_accelerator_design_axi_smc_0;

architecture stub of svm_accelerator_design_axi_smc_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN svm_accelerator_design_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_3f5c,Vivado 2024.2";
begin
end;
