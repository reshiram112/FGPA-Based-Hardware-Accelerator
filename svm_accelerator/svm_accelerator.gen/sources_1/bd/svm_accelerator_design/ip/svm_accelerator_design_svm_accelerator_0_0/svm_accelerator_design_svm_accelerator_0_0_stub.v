...
//               Sudheer/Desktop/svm_accelerator/svm_accelerator.gen/sources_1/bd/svm_accelerator_design/ip/svm_accelerator_design_svm_accelerator_0_0/svm_accelerator_design_svm_accelerator_0_0_stub.v}
...
(* CHECK_LICENSE_TYPE = "svm_accelerator_design_svm_accelerator_0_0,svm_accelerator,{}" *) (* CORE_GENERATION_INFO = "svm_accelerator_design_svm_accelerator_0_0,svm_accelerator,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=svm_accelerator,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "svm_accelerator,Vivado 2024.2" *) 
module svm_accelerator_design_svm_accelerator_0_0(aclk, aresetn, s_axis_tdata, s_axis_tvalid, 
...
/* synthesis syn_force_seq_prim="aclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 aclk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME aclk, ASSOCIATED_BUSIF m_axis:s_axis, ASSOCIATED_RESET aresetn, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN svm_accelerator_design_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
