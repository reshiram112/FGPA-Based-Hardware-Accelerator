...
with open("CNN/fpga/hls/cnn_top.h", "w") as f: f.write(cnn_h)
with open("CNN/fpga/hls/cnn_top.cpp", "w") as f: f.write(cnn_cpp)
with open("MLP/fpga/hls/mlp_top.h", "w") as f: f.write(mlp_h)
with open("MLP/fpga/hls/mlp_top.cpp", "w") as f: f.write(mlp_cpp)
