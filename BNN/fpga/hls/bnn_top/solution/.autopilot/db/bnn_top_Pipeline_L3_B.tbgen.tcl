set moduleName bnn_top_Pipeline_L3_B
set isTopModule 0
...
set cdfgNum 13
set C_modelName {bnn_top_Pipeline_L3_B}
...
set C_modelArgList {
	...
	{ act3 int 16 regular {array 256 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_input_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "act3", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ act3_address0 sc_out sc_lv 8 signal 7 } 
	{ act3_ce0 sc_out sc_logic 1 signal 7 } 
	{ act3_we0 sc_out sc_logic 1 signal 7 } 
	{ act3_d0 sc_out sc_lv 16 signal 7 } 
	{ act3_address1 sc_out sc_lv 8 signal 7 } 
	{ act3_ce1 sc_out sc_logic 1 signal 7 } 
	{ act3_q1 sc_in sc_lv 16 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "act3_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "act3", "role": "address1" }} , 
 	{ "name": "act3_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "act3", "role": "ce1" }} , 
 	{ "name": "act3_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "act3", "role": "q1" }}  ]}
...
set Spec2ImplPortList { 
	...
	act3 { ap_memory {  { act3_address0 mem_address 1 8 }  { act3_ce0 mem_ce 1 1 }  { act3_we0 mem_we 1 1 }  { act3_d0 mem_din 1 16 }  { act3_address1 MemPortADDR2 1 8 }  { act3_ce1 MemPortCE2 1 1 }  { act3_q1 MemPortDOUT2 0 16 } } }
}
