set moduleName bnn_top_Pipeline_L1_W_L1_IN
set isTopModule 0
...
set cdfgNum 13
set C_modelName {bnn_top_Pipeline_L1_W_L1_IN}
...
set C_modelArgList {
	...
	{ act1 int 16 regular {array 256 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_input_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "act1", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ input_r_address0 sc_out sc_lv 6 signal 7 } 
	{ input_r_ce0 sc_out sc_logic 1 signal 7 } 
	{ input_r_q0 sc_in sc_lv 16 signal 7 } 
	{ act1_address0 sc_out sc_lv 8 signal 8 } 
	{ act1_ce0 sc_out sc_logic 1 signal 8 } 
	{ act1_we0 sc_out sc_logic 1 signal 8 } 
	{ act1_d0 sc_out sc_lv 16 signal 8 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	act1 { ap_memory {  { act1_address0 mem_address 1 8 }  { act1_ce0 mem_ce 1 1 }  { act1_we0 mem_we 1 1 }  { act1_d0 mem_din 1 16 } } }
}
