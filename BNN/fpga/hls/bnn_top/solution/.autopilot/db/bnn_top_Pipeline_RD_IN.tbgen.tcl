set moduleName bnn_top_Pipeline_RD_IN
set isTopModule 0
...
set cdfgNum 13
set C_modelName {bnn_top_Pipeline_RD_IN}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict input_r { MEM_WIDTH 16 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	...
	{ input_r int 16 regular {array 64 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_input_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ input_r_we0 sc_out sc_logic 1 signal 7 } 
	{ input_r_d0 sc_out sc_lv 16 signal 7 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	input_r { ap_memory {  { input_r_address0 mem_address 1 6 }  { input_r_ce0 mem_ce 1 1 }  { input_r_we0 mem_we 1 1 }  { input_r_d0 mem_din 1 16 } } }
}
