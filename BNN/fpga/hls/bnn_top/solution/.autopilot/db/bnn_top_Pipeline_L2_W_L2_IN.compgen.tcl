...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename act1 \
    op interface \
    ports { act1_address0 { O 8 vector } act1_ce0 { O 1 bit } act1_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'act1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename act2 \
    op interface \
    ports { act2_address0 { O 8 vector } act2_ce0 { O 1 bit } act2_we0 { O 1 bit } act2_d0 { O 16 vector } } \
} "
} else {
