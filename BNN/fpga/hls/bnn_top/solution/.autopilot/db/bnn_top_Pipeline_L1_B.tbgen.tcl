set moduleName bnn_top_Pipeline_L1_B
set isTopModule 0
...
set cdfgNum 13
set C_modelName {bnn_top_Pipeline_L1_B}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict act1 { MEM_WIDTH 16 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	...
	{ act1 int 16 regular {array 256 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_input_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "act1", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ act1_address0 sc_out sc_lv 8 signal 7 } 
	{ act1_ce0 sc_out sc_logic 1 signal 7 } 
	{ act1_we0 sc_out sc_logic 1 signal 7 } 
	{ act1_d0 sc_out sc_lv 16 signal 7 } 
	{ act1_address1 sc_out sc_lv 8 signal 7 } 
	{ act1_ce1 sc_out sc_logic 1 signal 7 } 
	{ act1_q1 sc_in sc_lv 16 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "act1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "act1", "role": "address0" }} , 
 	{ "name": "act1_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "act1", "role": "ce0" }} , 
 	{ "name": "act1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "act1", "role": "we0" }} , 
 	{ "name": "act1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "act1", "role": "d0" }} , 
 	{ "name": "act1_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "act1", "role": "address1" }} , 
 	{ "name": "act1_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "act1", "role": "ce1" }} , 
 	{ "name": "act1_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "act1", "role": "q1" }}  ]}
...
set Spec2ImplPortList { 
	...
	act1 { ap_memory {  { act1_address0 mem_address 1 8 }  { act1_ce0 mem_ce 1 1 }  { act1_we0 mem_we 1 1 }  { act1_d0 mem_din 1 16 }  { act1_address1 MemPortADDR2 1 8 }  { act1_ce1 MemPortCE2 1 1 }  { act1_q1 MemPortDOUT2 0 16 } } }
}
