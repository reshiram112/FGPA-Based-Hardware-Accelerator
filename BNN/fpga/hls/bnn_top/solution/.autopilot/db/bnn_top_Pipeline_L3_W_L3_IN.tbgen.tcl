set moduleName bnn_top_Pipeline_L3_W_L3_IN
set isTopModule 0
...
set cdfgNum 13
set C_modelName {bnn_top_Pipeline_L3_W_L3_IN}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict act2 { MEM_WIDTH 16 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict act3 { MEM_WIDTH 16 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	...
	{ act2 int 16 regular {array 256 { 1 3 } 1 1 }  }
	{ act3 int 16 regular {array 256 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_input_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "act2", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "act3", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ act2_q0 sc_in sc_lv 16 signal 7 } 
	{ act3_address0 sc_out sc_lv 8 signal 8 } 
	{ act3_ce0 sc_out sc_logic 1 signal 8 } 
	{ act3_we0 sc_out sc_logic 1 signal 8 } 
	{ act3_d0 sc_out sc_lv 16 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "act2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "act2", "role": "q0" }} , 
 	...
 	{ "name": "act3_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "act3", "role": "we0" }} , 
 	{ "name": "act3_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "act3", "role": "d0" }}  ]}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "65541", "Max" : "65541"}
]}
...
set Spec2ImplPortList { 
	...
	act2 { ap_memory {  { act2_address0 mem_address 1 8 }  { act2_ce0 mem_ce 1 1 }  { act2_q0 mem_dout 0 16 } } }
	act3 { ap_memory {  { act3_address0 mem_address 1 8 }  { act3_ce0 mem_ce 1 1 }  { act3_we0 mem_we 1 1 }  { act3_d0 mem_din 1 16 } } }
}
