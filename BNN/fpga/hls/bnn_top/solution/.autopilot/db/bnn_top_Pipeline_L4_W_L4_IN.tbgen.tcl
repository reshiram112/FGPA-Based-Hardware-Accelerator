set moduleName bnn_top_Pipeline_L4_W_L4_IN
set isTopModule 0
...
set cdfgNum 13
set C_modelName {bnn_top_Pipeline_L4_W_L4_IN}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict act3 { MEM_WIDTH 16 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ act4 int 16 regular {pointer 1}  }
	...
	{ act3 int 16 regular {array 256 { 1 3 } 1 1 }  }
	{ act4_1 int 16 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "act4", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "act3", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "act4_1", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ s_axis_input_TVALID sc_in sc_logic 1 invld 1 } 
	{ act4 sc_out sc_lv 16 signal 0 } 
	{ act4_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ s_axis_input_TDATA sc_in sc_lv 32 signal 1 } 
	{ s_axis_input_TREADY sc_out sc_logic 1 inacc 7 } 
	{ s_axis_input_TKEEP sc_in sc_lv 4 signal 2 } 
	{ s_axis_input_TSTRB sc_in sc_lv 4 signal 3 } 
	{ s_axis_input_TUSER sc_in sc_lv 1 signal 4 } 
	{ s_axis_input_TLAST sc_in sc_lv 1 signal 5 } 
	{ s_axis_input_TID sc_in sc_lv 1 signal 6 } 
	{ s_axis_input_TDEST sc_in sc_lv 1 signal 7 } 
	{ act3_address0 sc_out sc_lv 8 signal 8 } 
	{ act3_ce0 sc_out sc_logic 1 signal 8 } 
	{ act3_q0 sc_in sc_lv 16 signal 8 } 
	{ act4_1 sc_out sc_lv 16 signal 9 } 
	{ act4_1_ap_vld sc_out sc_logic 1 outvld 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "act4", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "act4", "role": "default" }} , 
 	{ "name": "act4_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "act4", "role": "ap_vld" }} , 
 	...
 	{ "name": "act3_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "act3", "role": "address0" }} , 
 	{ "name": "act3_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "act3", "role": "ce0" }} , 
 	{ "name": "act3_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "act3", "role": "q0" }} , 
 	{ "name": "act4_1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "act4_1", "role": "default" }} , 
 	{ "name": "act4_1_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "act4_1", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	act4 { ap_vld {  { act4 out_data 1 16 }  { act4_ap_vld out_vld 1 1 } } }
	...
	act3 { ap_memory {  { act3_address0 mem_address 1 8 }  { act3_ce0 mem_ce 1 1 }  { act3_q0 mem_dout 0 16 } } }
	act4_1 { ap_vld {  { act4_1 out_data 1 16 }  { act4_1_ap_vld out_vld 1 1 } } }
}
