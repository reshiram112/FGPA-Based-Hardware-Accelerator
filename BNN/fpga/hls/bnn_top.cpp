...
// BNN on-the-fly computation
// The weights stream in dynamically. They have been folded with BN offline.
// Order: Image (64), W1(256x64), b1(256), W2(256x256), b2(256), W3(256x256), b3(256), W4(2x256), b4(2)
...
void bnn_top(
    ...
    L1_B: for (int o = 0; o < L1; o++) {
        ...
        act1[o] = (acc > 0) ? (data_t)1.0 : (data_t)-1.0;
    }

    // ── 3. Layer 2: dense + Sign ────────────────────────────────
    data_t act2[L2];
    ...
    L2_B: for (int o = 0; o < L2; o++) {
        ...
        act2[o] = (acc > 0) ? (data_t)1.0 : (data_t)-1.0;
    }

    // ── 4. Layer 3: dense + Sign ────────────────────────────────
    data_t act3[L3];
    ...
    L3_B: for (int o = 0; o < L3; o++) {
        ...
        act3[o] = (acc > 0) ? (data_t)1.0 : (data_t)-1.0;
    }

    // ── 5. Layer 4: dense (no Sign, logits) ─────────────────────
    data_t act4[L4];
