...
entity mlp_top_dense_relu_512_256_Pipeline_BIAS_LOAD is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of mlp_top_dense_relu_512_256_Pipeline_BIAS_LOAD is 
...
attribute shreg_extract : string;
    ...
    signal o_3_reg_127 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal o_3_reg_127_pp0_iter1_reg : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal o_fu_48 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
    signal add_ln31_fu_94_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                o_3_reg_127 <= ap_sig_allocacmp_o_3;
                o_3_reg_127_pp0_iter1_reg <= o_3_reg_127;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln31_fu_94_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_o_3) + unsigned(ap_const_lv9_1));
    ...
    ap_sig_allocacmp_o_3_assign_proc : process(ap_CS_fsm_pp0_stage0, o_fu_48, ap_loop_init, ap_block_pp0_stage0)
    begin
    ...
    bias_address0 <= zext_ln31_fu_111_p1(8 - 1 downto 0);
    ...
    icmp_ln31_fu_88_p2 <= "1" when (ap_sig_allocacmp_o_3 = ap_const_lv9_100) else "0";
    ...
    zext_ln31_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(o_3_reg_127_pp0_iter1_reg),64));
end behav;
