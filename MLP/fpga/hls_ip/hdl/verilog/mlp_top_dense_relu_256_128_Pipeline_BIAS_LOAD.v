...
module mlp_top_dense_relu_256_128_Pipeline_BIAS_LOAD (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7:0] o_4_reg_127_pp0_iter1_reg;
reg   [15:0] weights_addr_read_reg_136;
wire   [63:0] zext_ln31_fu_111_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [7:0] o_fu_48;
wire   [7:0] add_ln31_fu_94_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_o_4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln31_fu_88_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln31_fu_88_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln31_fu_94_p2 = (ap_sig_allocacmp_o_4 + 8'd1);
...
assign bias_address0 = zext_ln31_fu_111_p1;

assign bias_ce0 = bias_ce0_local;

assign bias_d0 = weights_addr_read_reg_136;

assign bias_we0 = bias_we0_local;

assign icmp_ln31_fu_88_p2 = ((ap_sig_allocacmp_o_4 == 8'd128) ? 1'b1 : 1'b0);
...
assign zext_ln31_fu_111_p1 = o_4_reg_127_pp0_iter1_reg;

endmodule //mlp_top_dense_relu_256_128_Pipeline_BIAS_LOAD
